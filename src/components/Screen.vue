<template>
  <div class="my-6 w-full">
    <div class="flex items-end justify-center mb-2 bg-white">
      <span @click="previewSize = 'w-mobile'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-mobile'}">
      ...
      <span @click="previewSize = 'w-tablet'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-tablet'}">
      ...
      <span @click="previewSize = 'w-laptop'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-laptop'}">
      ...
      <span @click="previewSize = 'w-desktop'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-desktop'}">
    ...
    <div class="mt-8 w-full flex justify-center">
      <div v-if="previewSize != 'code'" class="block shadow-lg rounded-lg" :class="[previewSize]">
      ...
      <Code v-else :code="source" class="max-w-full" />
    </div>
  </div>
</template>
