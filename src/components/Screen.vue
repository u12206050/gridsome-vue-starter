<template>
  <div class="my-6 w-full msm:w-screen overflow-x-hidden msm:-mx-6">
    <div class="flex items-end justify-center mb-2 bg-white w-full">
      <button title="380px" @click="previewSize = 'w-mobile max-w-full overflow-x-hidden', previewInner='h-mobile'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-mobile max-w-full overflow-x-hidden'}">
      ...
      <button title="768px" @click="previewSize = 'w-tablet', previewInner='h-tablet'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-tablet'}">
      ...
      <button title="1024px" @click="previewSize = 'w-laptop', previewInner='h-laptop'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-laptop'}">
      ...
      <button title="1280px" @click="previewSize = 'w-desktop', previewInner='h-full'" class="inline-block text-center cursor-pointer select-none mr-8 text-gray-500" :class="{'text-gray-800': previewSize == 'w-desktop'}">
