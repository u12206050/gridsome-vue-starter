<template>
  <g-link :to="path" class="card-widget block rounded shadow-md py-1 px-2 max-w-lg bg-white text-gray-800">
    ...
    <span class="flex pt-1">
      <span class="flex-auto w-4/5 pr-1">
        <h5 class="text-sm font-medium capitalize">{{title}}</h5>
        <p class="text-xs text-gray-600 truncate max-w-full">{{excerpt}}</p>
        <p class="text-sm pt-1 text-gray-600">{{readTime}} min read</p>
      </span>
