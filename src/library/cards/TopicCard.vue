<template>
  <g-link :href="path" class="card select-none block rounded-lg shadow-lg border border-gray-300 hover:shadow-md p-4 max-w-lg bg-white text-gray-600" :class="{stacked}">
